    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-5 py-2 text-sm font-medium text-white transition duration-200 bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
                        Log in
                    </a>
            ...
            <div class="max-w-5xl mx-auto text-center">
                ...
                <div class="grid gap-6 text-left md:grid-cols-2">
                    <div class="p-6 bg-white rounded shadow">
                        <h2 class="mb-2 text-xl font-semibold text-blue-600">✅ Project Management</h2>
                        <ul class="text-gray-700 list-disc list-inside">
                            <li>Create, update, and delete projects ( * Delete not implemented)</li>
                            <li>Assign users to projects</li>
                            <li>Search through projects using Livewire</li>
                        </ul>
                    </div>

                    <div class="p-6 bg-white rounded shadow">
                        <h2 class="mb-2 text-xl font-semibold text-green-600">✅ Task Management</h2>
                        <ul class="text-gray-700 list-disc list-inside">
                            <li>Add, edit, and delete tasks under projects</li>
                            <li>Real-time task updates using Livewire</li>
                            <li>Task progress tracking</li>
                        </ul>
                    </div>

                    <div class="p-6 bg-white rounded shadow">
                        <h2 class="mb-2 text-xl font-semibold text-purple-600">✅ User Management</h2>
                        <ul class="text-gray-700 list-disc list-inside">
                            <li>Add and manage users</li>
                            <li>Only Admins have access to login for now</li>
                        </ul>
                    </div>

                    <div class="p-6 bg-white rounded shadow">
                        <h2 class="mb-2 text-xl font-semibold text-yellow-600">✅ Authentication & Access Control</h2>
                        <ul class="text-gray-700 list-disc list-inside">
                            <li>Secure login system with validation</li>
                            <li>Admin-only access for certain features</li>
                            <li>Session management with redirect handling</li>
                        </ul>
                    </div>
                </div>
            </div>
